...
Euler angles break down the 3x3 rotation matrix or the Direction Cosign Matrix (DCM) into three elementary rotations about the original set of axes. For a 313 
