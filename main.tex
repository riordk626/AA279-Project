...
\hline
PS9 & - Modeled Reaction Wheels and Magnetorquer \\
    & - Implemented PD Control Law with Ground Truth Inputs \\
\hline
PS10 & - Revised description of actuator models in PS9 \\
    & - Added saturation and spin-up dynamics to reaction wheel model \\
    & - Coupled control law with reaction wheel actuators \\
    & - Completed MEKF for integration with feedback control law \\
\hline \hline
\end{tabular}
